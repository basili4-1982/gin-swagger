...
[![Build Status](https://github.com/basili4-1982/gin-swagger/actions/workflows/ci.yml/badge.svg?branch=master)](https://github.com/features/actions)
[![Codecov branch](https://img.shields.io/codecov/c/github/basili4-1982/gin-swagger/master.svg)](https://codecov.io/gh/basili4-1982/gin-swagger)
[![Go Report Card](https://goreportcard.com/badge/github.com/basili4-1982/gin-swagger)](https://goreportcard.com/report/github.com/basili4-1982/gin-swagger)
[![GoDoc](https://godoc.org/github.com/basili4-1982/gin-swagger?status.svg)](https://godoc.org/github.com/basili4-1982/gin-swagger)
[![Release](https://img.shields.io/github/release/basili4-1982/gin-swagger.svg?style=flat-square)](https://github.com/basili4-1982/gin-swagger/releases)
...
4. Download [gin-swagger](https://github.com/basili4-1982/gin-swagger) by using:

```sh
go get -u github.com/basili4-1982/gin-swagger
...
```go
import "github.com/basili4-1982/gin-swagger" // gin-swagger middleware
...
import (
   ...
   ginSwagger "github.com/basili4-1982/gin-swagger"
   "net/http"
)
// @BasePath /api/v1
