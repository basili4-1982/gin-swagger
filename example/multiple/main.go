...
import (
	...
	v1 "github.com/basili4-1982/gin-swagger/example/multiple/api/v1"
	v2 "github.com/basili4-1982/gin-swagger/example/multiple/api/v2"
	_ "github.com/basili4-1982/gin-swagger/example/multiple/docs"
)
